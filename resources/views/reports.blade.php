                    ...
                    <div
                        ...
                        <table class="w-full text-left text-sm text-neutral-600 dark:text-neutral-300">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="p-4">Pedido</th>
                                ...
                                <th scope="col" class="p-4">Imprimir</th>
                            </tr>
                            </thead>
                            ...
                            <tr>
                                ...
                                <td class="p-4">
                                    <div class="flex w-max items-center gap-2">
                                        <div class="flex flex-col">
                                            <span class="text-neutral-900 dark:text-white">Pedido 1</span>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="p-4"><span
                                        class="inline-flex overflow-hidden rounded-md border border-green-500 px-1 py-0.5 text-xs font-medium text-green-500 bg-green-500/10">Ativo</span>
                                </td>
                                <td class="p-4">
                                    <button type="button"
