                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <article
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 p-6">
                            ...
                            <div class="flex flex-col gap-2 text-neutral-600 dark:text-neutral-300">
                                <label for="emailInput" class="w-fit pl-0.5 text-sm">Código</label>
                                <input id="emailInput" type="email"
                                       ...
                                       disabled:cursor-not-allowed disabled:opacity-75 dark:border-neutral-700
                                       dark:bg-neutral-900/50 dark:focus-visible:outline-white"
                                       name="email" placeholder="Digite o código" autocomplete="email"/>
                            </div>
